...
if __name__ == '__main__':
  ...
  for episode in range(1, opts.episodes+1):
    ...
    returns_sum.append(episode_return)
  if opts.episodes > 0:
    mean= np.mean(returns_sum)
    std = np.std(returns_sum)

  print(f"Mean Over The Returns Of Episodes: {mean}")
  print(f"Standard Deviation of Episode Returns: {std}")
  ...
  print(f"Required number of episodes for ±{confidence_interval} confidence interval: {required_episodes}")
